...
function initUI()
    ...
    buildGui({0}, buyTab0)
    buildGui({1, 2, 3}, buyTab1)
    buildGui({4, 5, 6}, buyTab2)
    buildGui({7, 8, 9}, buyTab3)
...
function foundFactory(goodName, productionIndex)
    ...
    local station = transformToStation()
...
function transformToStation()
    ...
    -- create station
    local station = sector:createStation(player, plan, ship.position, "data/scripts/entity/crewboard.lua")
